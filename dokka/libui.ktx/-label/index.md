//[.](../../index.md)/[libui.ktx](../index.md)/[Label](index.md)
...
class [Label](index.md)(**text**: String) : [Control](../-control/index.md)<<ERROR CLASS>>    
...
|  Name|  Summary| 
|---|---|
| [Label](-label.md)|  [linux, macosx, windows64, windows] fun [Label](-label.md)(text: String)   <br>
...
|  Name|  Summary| 
|---|---|
| [disposed](index.md#libui.ktx/Label/disposed/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns true if object was disposed - in this case dispose will do nothing, all other operations are invalid and will throw Error("Resource is disposed").<br><br>override val [disposed](index.md#libui.ktx/Label/disposed/#/PointingToDeclaration/): Boolean   <br>
| [enabled](index.md#libui.ktx/Label/enabled/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be enabled or disabled. Defaults to true.<br><br>override var [enabled](index.md#libui.ktx/Label/enabled/#/PointingToDeclaration/): Boolean   <br>
| [parent](index.md#libui.ktx/Label/parent/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns parent of the control or null for detached.<br><br>override var [parent](index.md#libui.ktx/Label/parent/#/PointingToDeclaration/): [Control](../-control/index.md)<*>?   <br>
| [text](index.md#libui.ktx/Label/text/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>The static text of the label.<br><br>var [text](index.md#libui.ktx/Label/text/#/PointingToDeclaration/): String   <br>
| [toplevel](index.md#libui.ktx/Label/toplevel/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns whether the control is a top level one or not.<br><br>override val [toplevel](index.md#libui.ktx/Label/toplevel/#/PointingToDeclaration/): Boolean   <br>
| [visible](index.md#libui.ktx/Label/visible/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be visible or hidden. Defaults to true.<br><br>override var [visible](index.md#libui.ktx/Label/visible/#/PointingToDeclaration/): Boolean   <br>
