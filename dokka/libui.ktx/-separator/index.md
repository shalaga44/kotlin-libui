//[.](../../index.md)/[libui.ktx](../index.md)/[Separator](index.md)
...
abstract class [Separator](index.md)(**alloc**: CPointer<<ERROR CLASS>>?) : [Control](../-control/index.md)<<ERROR CLASS>>    
...
|  Name|  Summary| 
|---|---|
| [Separator](-separator.md)|  [linux, macosx, windows64, windows] fun [Separator](-separator.md)(alloc: CPointer<<ERROR CLASS>>?)   <br>
...
|  Name|  Summary| 
|---|---|
| [disposed](index.md#libui.ktx/Separator/disposed/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns true if object was disposed - in this case dispose will do nothing, all other operations are invalid and will throw Error("Resource is disposed").<br><br>override val [disposed](index.md#libui.ktx/Separator/disposed/#/PointingToDeclaration/): Boolean   <br>
| [enabled](index.md#libui.ktx/Separator/enabled/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be enabled or disabled. Defaults to true.<br><br>override var [enabled](index.md#libui.ktx/Separator/enabled/#/PointingToDeclaration/): Boolean   <br>
| [parent](index.md#libui.ktx/Separator/parent/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns parent of the control or null for detached.<br><br>override var [parent](index.md#libui.ktx/Separator/parent/#/PointingToDeclaration/): [Control](../-control/index.md)<*>?   <br>
| [toplevel](index.md#libui.ktx/Separator/toplevel/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns whether the control is a top level one or not.<br><br>override val [toplevel](index.md#libui.ktx/Separator/toplevel/#/PointingToDeclaration/): Boolean   <br>
| [visible](index.md#libui.ktx/Separator/visible/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be visible or hidden. Defaults to true.<br><br>override var [visible](index.md#libui.ktx/Separator/visible/#/PointingToDeclaration/): Boolean   <br>
...
|  Name| 
|---|
| [HorizontalSeparator](../-horizontal-separator/index.md)
| [VerticalSeparator](../-vertical-separator/index.md)
