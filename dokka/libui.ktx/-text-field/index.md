//[.](../../index.md)/[libui.ktx](../index.md)/[TextField](index.md)
...
open class [TextField](index.md) : [Control](../-control/index.md)<<ERROR CLASS>>    
...
|  Name|  Summary| 
|---|---|
| [TextField](-text-field.md)|  [linux, macosx, windows64, windows] fun [TextField](-text-field.md)()   <br>
...
|  Name|  Summary| 
|---|---|
| [disposed](index.md#libui.ktx/TextField/disposed/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns true if object was disposed - in this case dispose will do nothing, all other operations are invalid and will throw Error("Resource is disposed").<br><br>override val [disposed](index.md#libui.ktx/TextField/disposed/#/PointingToDeclaration/): Boolean   <br>
| [enabled](index.md#libui.ktx/TextField/enabled/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be enabled or disabled. Defaults to true.<br><br>override var [enabled](index.md#libui.ktx/TextField/enabled/#/PointingToDeclaration/): Boolean   <br>
| [parent](index.md#libui.ktx/TextField/parent/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns parent of the control or null for detached.<br><br>override var [parent](index.md#libui.ktx/TextField/parent/#/PointingToDeclaration/): [Control](../-control/index.md)<*>?   <br>
| [readonly](index.md#libui.ktx/TextField/readonly/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the text is read-only or not. Defaults to false.<br><br>var [readonly](index.md#libui.ktx/TextField/readonly/#/PointingToDeclaration/): Boolean   <br>
| [toplevel](index.md#libui.ktx/TextField/toplevel/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns whether the control is a top level one or not.<br><br>override val [toplevel](index.md#libui.ktx/TextField/toplevel/#/PointingToDeclaration/): Boolean   <br>
| [value](index.md#libui.ktx/TextField/value/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>The current text of the TextField.<br><br>var [value](index.md#libui.ktx/TextField/value/#/PointingToDeclaration/): String   <br>
| [visible](index.md#libui.ktx/TextField/visible/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be visible or hidden. Defaults to true.<br><br>override var [visible](index.md#libui.ktx/TextField/visible/#/PointingToDeclaration/): Boolean   <br>
