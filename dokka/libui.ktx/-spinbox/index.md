//[.](../../index.md)/[libui.ktx](../index.md)/[Spinbox](index.md)
...
class [Spinbox](index.md)(**min**: Int,**max**: Int) : [Control](../-control/index.md)<<ERROR CLASS>>    
...
|  Name|  Summary| 
|---|---|
| [Spinbox](-spinbox.md)|  [linux, macosx, windows64, windows] fun [Spinbox](-spinbox.md)(min: Int, max: Int)   <br>
...
|  Name|  Summary| 
|---|---|
| [action](action.md)| [linux, macosx, windows64, windows]  <br>Brief description  <br><br><br>Function to be run when the user makes a change to the Spinbox. Only one function can be registered at a time.<br><br>  <br>Content  <br>[linux, macosx, windows64, windows]  <br>fun [action](action.md)(block: [Spinbox](index.md).() -> Unit)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| [disposed](index.md#libui.ktx/Spinbox/disposed/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns true if object was disposed - in this case dispose will do nothing, all other operations are invalid and will throw Error("Resource is disposed").<br><br>override val [disposed](index.md#libui.ktx/Spinbox/disposed/#/PointingToDeclaration/): Boolean   <br>
| [enabled](index.md#libui.ktx/Spinbox/enabled/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be enabled or disabled. Defaults to true.<br><br>override var [enabled](index.md#libui.ktx/Spinbox/enabled/#/PointingToDeclaration/): Boolean   <br>
| [parent](index.md#libui.ktx/Spinbox/parent/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns parent of the control or null for detached.<br><br>override var [parent](index.md#libui.ktx/Spinbox/parent/#/PointingToDeclaration/): [Control](../-control/index.md)<*>?   <br>
| [toplevel](index.md#libui.ktx/Spinbox/toplevel/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns whether the control is a top level one or not.<br><br>override val [toplevel](index.md#libui.ktx/Spinbox/toplevel/#/PointingToDeclaration/): Boolean   <br>
| [value](index.md#libui.ktx/Spinbox/value/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>The current numeric value of the spinbox.<br><br>var [value](index.md#libui.ktx/Spinbox/value/#/PointingToDeclaration/): Int   <br>
| [visible](index.md#libui.ktx/Spinbox/visible/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be visible or hidden. Defaults to true.<br><br>override var [visible](index.md#libui.ktx/Spinbox/visible/#/PointingToDeclaration/): Boolean   <br>
