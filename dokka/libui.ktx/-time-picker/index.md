//[.](../../index.md)/[libui.ktx](../index.md)/[TimePicker](index.md)
...
class [TimePicker](index.md) : [DateTimePicker](../-date-time-picker/index.md)   
...
|  Name|  Summary| 
|---|---|
| [TimePicker](-time-picker.md)|  [linux, macosx, windows64, windows] fun [TimePicker](-time-picker.md)()   <br>
...
|  Name|  Summary| 
|---|---|
| [action](../-date-time-picker/action.md)| [linux, macosx, windows64, windows]  <br>Brief description  <br><br><br>Function to be run when the user makes a change to the Picker. Only one function can be registered at a time.<br><br>  <br>Content  <br>[linux, macosx, windows64, windows]  <br>override fun [action](../-date-time-picker/action.md)(block: [DateTimePicker](../-date-time-picker/index.md).() -> Unit)  <br><br><br>
...
| [getValue](../-date-time-picker/get-value.md)| [linux, windows64, windows, macosx]  <br>Brief description  <br><br><br>The current value as posix struct tm<br><br>  <br>Content  <br>[linux, windows64, windows]  <br>override fun [getValue](../-date-time-picker/get-value.md)(value: CPointer<tm>)  <br>[macosx]  <br>override fun [getValue](../-date-time-picker/get-value.md)(value: CPointer<<ERROR CLASS>>): <ERROR CLASS>  <br><br><br>
...
| [setValue](../-date-time-picker/set-value.md)| [linux, windows64, windows, macosx]  <br>Brief description  <br><br><br>Set current value from posix struct tm<br><br>  <br>Content  <br>[linux, windows64, windows]  <br>override fun [setValue](../-date-time-picker/set-value.md)(value: CPointer<tm>)  <br>[macosx]  <br>override fun [setValue](../-date-time-picker/set-value.md)(value: CPointer<<ERROR CLASS>>): <ERROR CLASS>  <br><br><br>
...
| [textValue](../-date-time-picker/text-value.md)| [linux, macosx, windows64, windows]  <br>Brief description  <br><br><br>The current value as String.<br><br>  <br>Content  <br>[linux, macosx, windows64, windows]  <br>override fun [textValue](../-date-time-picker/text-value.md)(format: String): String  <br><br><br>
