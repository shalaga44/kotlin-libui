//[.](../../index.md)/[libui.ktx](../index.md)/[HorizontalSeparator](index.md)
...
class [HorizontalSeparator](index.md) : [Separator](../-separator/index.md)   
...
|  Name|  Summary| 
|---|---|
| [HorizontalSeparator](-horizontal-separator.md)|  [linux, macosx, windows64, windows] fun [HorizontalSeparator](-horizontal-separator.md)()   <br>
...
|  Name|  Summary| 
|---|---|
| [disposed](index.md#libui.ktx/HorizontalSeparator/disposed/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns true if object was disposed - in this case dispose will do nothing, all other operations are invalid and will throw Error("Resource is disposed").<br><br>override val [disposed](index.md#libui.ktx/HorizontalSeparator/disposed/#/PointingToDeclaration/): Boolean   <br>
| [enabled](index.md#libui.ktx/HorizontalSeparator/enabled/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be enabled or disabled. Defaults to true.<br><br>override var [enabled](index.md#libui.ktx/HorizontalSeparator/enabled/#/PointingToDeclaration/): Boolean   <br>
| [parent](index.md#libui.ktx/HorizontalSeparator/parent/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns parent of the control or null for detached.<br><br>override var [parent](index.md#libui.ktx/HorizontalSeparator/parent/#/PointingToDeclaration/): [Control](../-control/index.md)<*>?   <br>
| [toplevel](index.md#libui.ktx/HorizontalSeparator/toplevel/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns whether the control is a top level one or not.<br><br>override val [toplevel](index.md#libui.ktx/HorizontalSeparator/toplevel/#/PointingToDeclaration/): Boolean   <br>
| [visible](index.md#libui.ktx/HorizontalSeparator/visible/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be visible or hidden. Defaults to true.<br><br>override var [visible](index.md#libui.ktx/HorizontalSeparator/visible/#/PointingToDeclaration/): Boolean   <br>
