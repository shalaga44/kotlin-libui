//[.](../../index.md)/[libui.ktx](../index.md)/[ProgressBar](index.md)
...
class [ProgressBar](index.md) : [Control](../-control/index.md)<<ERROR CLASS>>    
...
|  Name|  Summary| 
|---|---|
| [ProgressBar](-progress-bar.md)|  [linux, macosx, windows64, windows] fun [ProgressBar](-progress-bar.md)()   <br>
...
|  Name|  Summary| 
|---|---|
| [disposed](index.md#libui.ktx/ProgressBar/disposed/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns true if object was disposed - in this case dispose will do nothing, all other operations are invalid and will throw Error("Resource is disposed").<br><br>override val [disposed](index.md#libui.ktx/ProgressBar/disposed/#/PointingToDeclaration/): Boolean   <br>
| [enabled](index.md#libui.ktx/ProgressBar/enabled/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be enabled or disabled. Defaults to true.<br><br>override var [enabled](index.md#libui.ktx/ProgressBar/enabled/#/PointingToDeclaration/): Boolean   <br>
| [parent](index.md#libui.ktx/ProgressBar/parent/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns parent of the control or null for detached.<br><br>override var [parent](index.md#libui.ktx/ProgressBar/parent/#/PointingToDeclaration/): [Control](../-control/index.md)<*>?   <br>
| [toplevel](index.md#libui.ktx/ProgressBar/toplevel/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns whether the control is a top level one or not.<br><br>override val [toplevel](index.md#libui.ktx/ProgressBar/toplevel/#/PointingToDeclaration/): Boolean   <br>
| [value](index.md#libui.ktx/ProgressBar/value/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>The current position of the progress bar. Could be set to -1 to create an indeterminate progress bar.<br><br>var [value](index.md#libui.ktx/ProgressBar/value/#/PointingToDeclaration/): Int   <br>
| [visible](index.md#libui.ktx/ProgressBar/visible/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be visible or hidden. Defaults to true.<br><br>override var [visible](index.md#libui.ktx/ProgressBar/visible/#/PointingToDeclaration/): Boolean   <br>
