//[.](../../index.md)/[libui.ktx](../index.md)/[TableView](index.md)
...
class [TableView](index.md)(**table**: [Table](../-table/index.md)<*>) : [Control](../-control/index.md)<<ERROR CLASS>>    
...
|  Name|  Summary| 
|---|---|
| [TableView](-table-view.md)|  [linux, macosx, windows64, windows] fun [TableView](-table-view.md)(table: [Table](../-table/index.md)<*>)   <br>
...
|  Name|  Summary| 
|---|---|
| [disposed](index.md#libui.ktx/TableView/disposed/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns true if object was disposed - in this case dispose will do nothing, all other operations are invalid and will throw Error("Resource is disposed").<br><br>override val [disposed](index.md#libui.ktx/TableView/disposed/#/PointingToDeclaration/): Boolean   <br>
| [enabled](index.md#libui.ktx/TableView/enabled/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be enabled or disabled. Defaults to true.<br><br>override var [enabled](index.md#libui.ktx/TableView/enabled/#/PointingToDeclaration/): Boolean   <br>
| [parent](index.md#libui.ktx/TableView/parent/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns parent of the control or null for detached.<br><br>override var [parent](index.md#libui.ktx/TableView/parent/#/PointingToDeclaration/): [Control](../-control/index.md)<*>?   <br>
| [table](index.md#libui.ktx/TableView/table/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] val [table](index.md#libui.ktx/TableView/table/#/PointingToDeclaration/): [Table](../-table/index.md)<*>   <br>
| [toplevel](index.md#libui.ktx/TableView/toplevel/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns whether the control is a top level one or not.<br><br>override val [toplevel](index.md#libui.ktx/TableView/toplevel/#/PointingToDeclaration/): Boolean   <br>
| [visible](index.md#libui.ktx/TableView/visible/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be visible or hidden. Defaults to true.<br><br>override var [visible](index.md#libui.ktx/TableView/visible/#/PointingToDeclaration/): Boolean   <br>
