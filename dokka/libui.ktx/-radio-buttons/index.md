//[.](../../index.md)/[libui.ktx](../index.md)/[RadioButtons](index.md)
...
class [RadioButtons](index.md) : [Control](../-control/index.md)<<ERROR CLASS>>    
...
|  Name|  Summary| 
|---|---|
| [RadioButtons](-radio-buttons.md)|  [linux, macosx, windows64, windows] fun [RadioButtons](-radio-buttons.md)()   <br>
...
|  Name|  Summary| 
|---|---|
| [action](action.md)| [linux, macosx, windows64, windows]  <br>Brief description  <br><br><br>Function to be run when the user makes a change to the RadioButtons. Only one function can be registered at a time.<br><br>  <br>Content  <br>[linux, macosx, windows64, windows]  <br>fun [action](action.md)(block: [RadioButtons](index.md).() -> Unit)  <br><br><br>
...
| [item](item.md)| [linux, macosx, windows64, windows]  <br>Brief description  <br><br><br>Adds the named button to the end of the radiobuttons. If it is the first button, it is automatically selected.<br><br>  <br>Content  <br>[linux, macosx, windows64, windows]  <br>fun [item](item.md)(text: String)  <br><br><br>
