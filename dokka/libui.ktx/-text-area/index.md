//[.](../../index.md)/[libui.ktx](../index.md)/[TextArea](index.md)
...
class [TextArea](index.md)(**wrap**: Boolean) : [Control](../-control/index.md)<<ERROR CLASS>>    
...
|  Name|  Summary| 
|---|---|
| [TextArea](-text-area.md)|  [linux, macosx, windows64, windows] fun [TextArea](-text-area.md)(wrap: Boolean)   <br>
...
|  Name|  Summary| 
|---|---|
| [action](action.md)| [linux, macosx, windows64, windows]  <br>Brief description  <br><br><br>Function to be run when the user makes a change to the TextArea. Only one function can be registered at a time.<br><br>  <br>Content  <br>[linux, macosx, windows64, windows]  <br>fun [action](action.md)(block: [TextArea](index.md).() -> Unit)  <br><br><br>
| [append](append.md)| [linux, macosx, windows64, windows]  <br>Brief description  <br><br><br>Adds the text to the end of the area.<br><br>  <br>Content  <br>[linux, macosx, windows64, windows]  <br>fun [append](append.md)(text: String)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| [disposed](index.md#libui.ktx/TextArea/disposed/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns true if object was disposed - in this case dispose will do nothing, all other operations are invalid and will throw Error("Resource is disposed").<br><br>override val [disposed](index.md#libui.ktx/TextArea/disposed/#/PointingToDeclaration/): Boolean   <br>
| [enabled](index.md#libui.ktx/TextArea/enabled/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be enabled or disabled. Defaults to true.<br><br>override var [enabled](index.md#libui.ktx/TextArea/enabled/#/PointingToDeclaration/): Boolean   <br>
| [parent](index.md#libui.ktx/TextArea/parent/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns parent of the control or null for detached.<br><br>override var [parent](index.md#libui.ktx/TextArea/parent/#/PointingToDeclaration/): [Control](../-control/index.md)<*>?   <br>
| [readonly](index.md#libui.ktx/TextArea/readonly/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the text is read-only or not. Defaults to false<br><br>var [readonly](index.md#libui.ktx/TextArea/readonly/#/PointingToDeclaration/): Boolean   <br>
| [toplevel](index.md#libui.ktx/TextArea/toplevel/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns whether the control is a top level one or not.<br><br>override val [toplevel](index.md#libui.ktx/TextArea/toplevel/#/PointingToDeclaration/): Boolean   <br>
| [value](index.md#libui.ktx/TextArea/value/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>The current text in the area.<br><br>var [value](index.md#libui.ktx/TextArea/value/#/PointingToDeclaration/): String   <br>
| [visible](index.md#libui.ktx/TextArea/visible/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be visible or hidden. Defaults to true.<br><br>override var [visible](index.md#libui.ktx/TextArea/visible/#/PointingToDeclaration/): Boolean   <br>
