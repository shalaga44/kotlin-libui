//[.](../../index.md)/[libui.ktx](../index.md)/[Group](index.md)
...
Wrapper class for uiGroup - a container for a single widget that provide a caption and visually group it's children.

  
  
class [Group](index.md)(**title**: String) : [Control](../-control/index.md)<<ERROR CLASS>> , [Container](../-container/index.md)   
...
|  Name|  Summary| 
|---|---|
| [Group](-group.md)|  [linux, macosx, windows64, windows] fun [Group](-group.md)(title: String)   <br>
...
|  Name|  Summary| 
|---|---|
| [add](add.md)| [linux, macosx, windows64, windows]  <br>Brief description  <br><br><br>Set the child widget of the Group.<br><br>  <br>Content  <br>[linux, macosx, windows64, windows]  <br>open override fun <[T](add.md) : [Control](../-control/index.md)<*>> [add](add.md)(widget: [T](add.md)): [T](add.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| [disposed](index.md#libui.ktx/Group/disposed/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns true if object was disposed - in this case dispose will do nothing, all other operations are invalid and will throw Error("Resource is disposed").<br><br>override val [disposed](index.md#libui.ktx/Group/disposed/#/PointingToDeclaration/): Boolean   <br>
| [enabled](index.md#libui.ktx/Group/enabled/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be enabled or disabled. Defaults to true.<br><br>override var [enabled](index.md#libui.ktx/Group/enabled/#/PointingToDeclaration/): Boolean   <br>
| [margined](index.md#libui.ktx/Group/margined/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Specify if the group content area should have a margin or not.<br><br>var [margined](index.md#libui.ktx/Group/margined/#/PointingToDeclaration/): Boolean   <br>
| [parent](index.md#libui.ktx/Group/parent/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns parent of the control or null for detached.<br><br>override var [parent](index.md#libui.ktx/Group/parent/#/PointingToDeclaration/): [Control](../-control/index.md)<*>?   <br>
| [title](index.md#libui.ktx/Group/title/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Specify the caption of the group.<br><br>var [title](index.md#libui.ktx/Group/title/#/PointingToDeclaration/): String   <br>
| [toplevel](index.md#libui.ktx/Group/toplevel/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Returns whether the control is a top level one or not.<br><br>override val [toplevel](index.md#libui.ktx/Group/toplevel/#/PointingToDeclaration/): Boolean   <br>
| [visible](index.md#libui.ktx/Group/visible/#/PointingToDeclaration/)|  [linux, macosx, windows64, windows] <br><br>Whether the Control should be visible or hidden. Defaults to true.<br><br>override var [visible](index.md#libui.ktx/Group/visible/#/PointingToDeclaration/): Boolean   <br>
